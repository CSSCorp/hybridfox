var ec2_InstanceLauncher = {
    ...
    launch : function() {
        ...
        this.retVal.kernelId = document.getElementById("ec2ui.spotinstances.aki").value;
        this.retVal.ramdiskId = document.getElementById("ec2ui.spotinstances.ari").value;
        this.retVal.instanceType = document.getElementById("ec2ui.spotinstances.instancetypelist").selectedItem.value;
        this.retVal.minCount = document.getElementById("ec2ui.spotinstances.min").value.trim();
        this.retVal.maxCount = document.getElementById("ec2ui.spotinstances.max").value.trim();
        this.retVal.tag = document.getElementById("ec2ui.spotinstances.tag").value.trim();
	this.retVal.spotprice = document.getElementById("ec2ui.spotinstances.spotprice.tag").value.trim();
        // This will be an empty string if <none> is selected
        this.retVal.keyName = document.getElementById("ec2ui.spotinstances.keypairlist").selectedItem.value;

        // This will be an empty string if <any> is selected
        var a = document.getElementById("ec2ui.spotinstances.availabilityzonelist").selectedItem.value;
        this.retVal.placement = {
            "availabilityZone": document.getElementById("ec2ui.spotinstances.availabilityzonelist").selectedItem.value
        };

        this.retVal.securityGroups = this.used;
        this.retVal.userData = document.getElementById("ec2ui.spotinstances.userdata").value;
        if (this.retVal.userData == "") {
            this.retVal.userData = null;
        }
        this.retVal.properties = document.getElementById("ec2ui.spotinstances.properties").value;
		...
		this.retVal.addressingType = (document.getElementById("ec2ui.spotinstances.addressingType").checked==true) ? "public" : "private";
    ...
    validateMin : function() {
        var textbox = document.getElementById("ec2ui.spotinstances.min");
        var val = parseInt(textbox.value);
        if (val <= 0 || isNaN(val)) {
            alert(ec2ui_utils.getMessageProperty("ec2ui.msg.spotinstancesdialog.alert.validateMin"));
            textbox.select();
            return false;
        }
        return true;
    ...
    validateMax : function() {
        ...
        var maxtextbox = document.getElementById("ec2ui.spotinstances.max");
        var maxval = parseInt(maxtextbox.value);
        if (maxval <= 0 || isNaN(maxval)) {
            alert(ec2ui_utils.getMessageProperty("ec2ui.msg.spotinstancesdialog.alert.validateMax.1"));
            maxtextbox.select();
            return false;
        }
        var mintextbox = document.getElementById("ec2ui.spotinstances.min");
        var minval = parseInt(mintextbox.value);
        if (minval > maxval) {
            alert(ec2ui_utils.getMessageProperty("ec2ui.msg.spotinstancesdialog.alert.validateMax.2"));
            maxtextbox.select();
            return false;
        }
        return true;
    ...
    loadUserDataFromFile : function(fBinary) {
        ...
        if (res == nsIFilePicker.returnOK) {
            ...
            document.getElementById("ec2ui.spotinstances.userdata").value = contents;
        }
    },
	...
	var image = window.arguments[0];
        ...
        if (keypairs == null) {
            alert (ec2ui_utils.getMessageProperty("ec2ui.msg.spotinstancesdialog.alert.init"));
            return false;
        }

        var keypairMenu = document.getElementById("ec2ui.spotinstances.keypairlist");
        ...
        var typeMenu = document.getElementById("ec2ui.spotinstances.instancetypelist");
        ...
        var textBox = document.getElementById("ec2ui.spotinstances.ami");
        textBox.value = this.image.id;

        textBox = document.getElementById("ec2ui.spotinstances.ami.tag");
        textBox.value = this.image.tag || "";

        textBox = document.getElementById("ec2ui.spotinstances.ami.location");
        textBox.value = this.image.location.split('/').pop();

        textBox = document.getElementById("ec2ui.spotinstances.min");
        textBox.focus();

        // availability zones
        var availZoneMenu = document.getElementById("ec2ui.spotinstances.availabilityzonelist");
        ...
        this.unusedSecGroupsList = document.getElementById("ec2ui.spotinstances.secgroups.unused");
        this.usedSecGroupsList = document.getElementById("ec2ui.spotinstances.secgroups.used");
        ...
        var akiList = document.getElementById("ec2ui.spotinstances.aki");
        var ariList = document.getElementById("ec2ui.spotinstances.ari");
    	...
    	if (this.ec2ui_session.isAmazonEndpointSelected()) {
    		document.getElementById("ec2ui.spotinstances.addressingType").disabled="true";
    	} else {
    		document.getElementById("ec2ui.spotinstances.addressingType").removeAttribute("disabled");
    	}
