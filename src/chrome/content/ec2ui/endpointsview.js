var ec2ui_endpointsTreeView = {
    COLNAMES: ['endpoint.name','endpoint.type','endpoint.url','endpoint.elburl'],
    treeBox: null,
    selection: null,
    ...
    setMapping : function(mapping) {
        ...
        this.endpointlist = mapping.toArray(function(k,v){return new Endpoint(k, v.type, v.url, v.elburl)});
        this.treeBox.rowCountChanged(0, this.endpointlist.length);
