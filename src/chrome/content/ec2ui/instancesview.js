    ...
    showBundleDialog : function() {
        ...
        do {
            ...
            if (!ec2ui_session.isAmazonEndpointSelected()) {
                // When Endpoint is not AWS, skip follow checks.(hybridfox's S3 client works only AWS Endpoint)
                //   Check the bucket exist (and create if not exist).
                //   Check the user owns the specified bucket.
                break;
            }
