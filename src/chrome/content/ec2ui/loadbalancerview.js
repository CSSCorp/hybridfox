var ec2ui_LoadbalancerTreeView = {
    ...
    create: function() {
        ...
        if (retVal.ok) {
                ...
                ec2ui_session.controller.CreateLoadBalancer(retVal.LoadBalancerName,retVal.Protocol,retVal.arn,retVal.elbport,retVal.instanceport,Zone);
    ...
    disablestickness :function(){
        var loadbalancer = this.getSelectedLoadbalancer();
        if (loadbalancer == null) return;
        var confirmed = confirm("Delete Stickness "+loadbalancer.LoadBalancerName+"?");
        if (!confirmed)
            return;
        var me = this;
        var wrap = function() {
